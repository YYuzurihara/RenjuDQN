...
この「今知っている中で一番良い手を打つ（活用）」か「まだ試していない手をあえて打ってみる（探索）」かのバランスを取る，最もシンプルな方法が epsilon-greedy 法である．
...
### NoisyNet
epsilon-greedy 法の $\varepsilon$ は人間があらかじめ決めた確率でしかなく，盤面ごとの事情を考慮していない．
...
学習が進んで自信のある行動ほど $\sigma$ が小さくなり自然と探索が減っていくため，epsilon-greedy 法のように $\varepsilon$ を人間が手動で調整・減衰させる必要がなくなる．